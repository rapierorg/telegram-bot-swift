...
public struct InputMediaAnimation: JsonConvertible, InternalJsonConvertible {
    ...
    public var thumb: FileInfo? {
        get {
            ...
            return value.isNullOrUnknown ? nil : FileInfo(internalJson: value)
        }
        set {
...
public var date: Date {
    ...
    public var newChatPhoto: [PhotoSize] {
        ...
        set { internalJson["new_chat_photo"] = JSON.initFrom(newValue) }
    }

    public var newChatTitle: String {
        get { return internalJson["new_chat_title"].stringValue }
        set { internalJson["new_chat_title"].stringValue = newValue }
    }

    public var passportData: PassportData? {
        get {
            let value = internalJson["passport_data"]
            return value.isNullOrUnknown ? nil : PassportData(internalJson: value)
        }
        set {
            internalJson["passport_data"] = newValue?.internalJson ?? JSON.null
        }
    }
...
public struct Chat: JsonConvertible, InternalJsonConvertible {
    ...
    public var canSetStickerSet: Boolean? {
        get {
            let value = internalJson["can_set_sticker_set"]
            return value.isNullOrUnknown ? nil : Boolean(internalJson: value)
        }
        set {
            internalJson["can_set_sticker_set"] = newValue?.internalJson ?? JSON.null
        }
    }
