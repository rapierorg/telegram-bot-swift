...
public extension TelegramBot {
	...
	@discardableResult
	public func sendContactSync(chat_id: ChatId, phone_number: String, first_name: String,
	...
	/// - SeeAlso: <https://core.telegram.org/bots/api#sendcontact>
	public func sendContactAsync(chat_id: ChatId, phone_number: String, first_name: String,
