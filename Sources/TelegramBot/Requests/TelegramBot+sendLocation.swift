...
public extension TelegramBot {
	...
	public func sendLocationSync(chatId: Int64, latitude: Double, longitude: Double,
	...
	/// - Returns: Sent message on success. Nil on error, in which case `lastError` contains the details.
	/// - SeeAlso: <https://core.telegram.org/bots/api#sendlocation>
	public func sendLocationSync(channelUserName: String, latitude: Double, longitude: Double,
	                            parameters: [String: Any?] = [:]) -> Message? {
		let allParameters: [String: Any?] =
			defaultParameters["sendLocation"] ?? [:] + parameters +
	...
	/// - SeeAlso: <https://core.telegram.org/bots/api#sendlocation>
	public func sendLocationAsync(chatId: Int64, latitude: Double, longitude: Double,
	...
	/// - Returns: Sent message on success. Nil on error, in which case `error` contains the details.
	/// - SeeAlso: <https://core.telegram.org/bots/api#sendlocation>
	public func sendLocationAsync(channelUserName: String, latitude: Double, longitude: Double,
	                             parameters: [String: Any?] = [:],
	                             queue: dispatch_queue_t = dispatch_get_main_queue(),
	                             completion: SendMessageCompletion? = nil) {
		let allParameters: [String: Any?] =
